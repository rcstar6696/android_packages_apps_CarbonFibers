...
public class Buttons extends CustomSettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, Indexable {
    ...
    private static final String FLASHLIGHT_PROXIMITYCHECK = "proximitycheck_torch";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addCustomPreference(findPreference(FLASHLIGHT_PROXIMITYCHECK), SYSTEM_TWO_STATE, STATE_ON);
